# GUI frame for the Stanislaus_PDFscript.py
...
import Stanislaus_PDFscript

class Stanislaus_frame:
	...
	def initUI(self):
		...
		choose_label = "Input file (.PDF Stanislaus):"
		...
		self.filelocation.insert(0, '../Files/Stanislaus/')
...
#		self.preview.grid(row=1, column=0, sticky=W, padx=(306,6))
		...
		#BUTTON TO SEE OUTPUT
#Might be good idea to add created CSV file "open" button
#		output_label = "Output:"
...
#		self.output.grid(row=7, column=0, padx=(60,5), pady=(10,15), sticky=W)
		...
		options['initialdir'] = '../Files/Stanislaus/'
		options['title'] = 'Open a file .pdf for Stanislaus'
	...
	def compute_model(self):
		...
		try:
			...
			Stanislaus_PDFscript.main(inputFile)
